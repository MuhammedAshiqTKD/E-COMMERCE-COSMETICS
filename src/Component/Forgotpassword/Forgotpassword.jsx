...
const Forgotpassword = () => {
    ...
    const EditPwd=async(e)=>{
      e.preventDefault()
      const res = await axios.get(`http://localhost:3333/eco/getemail/${val.username}`)
      let {data}=res
      // console.log(data);
      if(data.email!==val.email){
        ...
        const res= await axios.patch("http://localhost:3333/eco/adminpassword",{ password : val.password })
  ...
  return (
    ...
    <div className="adminregister">
        <Link to="/adminlogin">
          <button onClick={EditPwd} type='submit' > CHANGE NOW</button>
        </Link>
      </div>
      {/* </form> */}
    {/* <div className="adminregister">
