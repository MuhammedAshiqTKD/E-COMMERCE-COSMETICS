    ...
    <div>
      ...
      <form>
        ...
        <div className="admintext">
          ...
          <h1>* They set up and maintain security measures to protect sensitive data and ensure that only authorized individuals have access to certain functionalities.</h1>
        </div>
